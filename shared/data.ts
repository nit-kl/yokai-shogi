/* ============================================================
   百鬼盤 - 駒データ定義(shared: クライアント/サーバー共用)
...
export interface YokaiDef {
  ...
  atk: number;
  rarity: Rarity;
  boss?: true; // 大将。取られると敗北・編成に1体必須・成らない
  gachaOnly?: boolean;
...
export const YOKAI: Record<string, YokaiDef> = {
  ...
  /* ---------- 攻め ---------- */
  kooni: {
    id: 'kooni', name: '小鬼', atk: 150, rarity: 'N',
  ...
  nekomata: {
    id: 'nekomata', name: '猫又', atk: 200, rarity: 'R',
  ...
  ittan: {
    id: 'ittan', name: '一反木綿', atk: 250, rarity: 'R',
  ...
  nue: {
    id: 'nue', name: '鵺', atk: 300, rarity: 'SR',
  ...
  /* ---------- 守り ---------- */
  kappa: {
    id: 'kappa', name: '河童', atk: 120, rarity: 'N',
  ...
  nurikabe: {
    id: 'nurikabe', name: 'ぬりかべ', atk: 100, rarity: 'R',
  ...
  /* ---------- 反撃 ---------- */
  tengu: {
    id: 'tengu', name: '天狗', atk: 220, rarity: 'SR',
  ...
  rokuro: {
    id: 'rokuro', name: 'ろくろ首', atk: 180, rarity: 'R',
  ...
  /* ==================== ガチャ限定妖怪 ==================== */
  aooni: {
    id: 'aooni', name: '青鬼', atk: 190, rarity: 'R', gachaOnly: true,
  ...
  kasha: {
    id: 'kasha', name: '火車', atk: 230, rarity: 'R', gachaOnly: true,
  ...
  kamaitachi: {
    id: 'kamaitachi', name: '鎌鼬', atk: 230, rarity: 'R', gachaOnly: true,
  ...
  hitouban: {
    id: 'hitouban', name: '飛頭蛮', atk: 200, rarity: 'R', gachaOnly: true,
  ...
  ibaraki: {
    id: 'ibaraki', name: '茨木童子', atk: 320, rarity: 'SSR', gachaOnly: true,
  ...
  tamamo: {
    id: 'tamamo', name: '玉藻前', atk: 450, rarity: 'SSR', gachaOnly: true,
  ...
  /* ---------- 弱体 ---------- */
  sunakake: {
    id: 'sunakake', name: '砂かけ婆', atk: 120, rarity: 'N', gachaOnly: true,
  ...
  tsuchigumo: {
    id: 'tsuchigumo', name: '土蜘蛛', atk: 180, rarity: 'R', gachaOnly: true,
  ...
  yukionna: {
    id: 'yukionna', name: '雪女', atk: 220, rarity: 'SR', gachaOnly: true,
  ...
  /* ---------- 支援 ---------- */
  zashiki: {
    id: 'zashiki', name: '座敷童子', atk: 130, rarity: 'SR', gachaOnly: true,
  ...
  /* ---------- 変化 ---------- */
  tanuki: {
    id: 'tanuki', name: '化け狸', atk: 160, rarity: 'R', gachaOnly: true,
  ...
  /* ---------- 爆散 ---------- */
  onibi: {
    id: 'onibi', name: '鬼火', atk: 100, rarity: 'SR', gachaOnly: true,
  ...
  /* ---------- 新規追加妖怪 ---------- */
  karakasa: {
    id: 'karakasa', name: 'からかさ小僧', atk: 110, rarity: 'N', gachaOnly: true,
  ...
  chochin: {
    id: 'chochin', name: '提灯お化け', atk: 150, rarity: 'R', gachaOnly: true,
  ...
  baku: {
    id: 'baku', name: '獏', atk: 200, rarity: 'SR', gachaOnly: true,
  ...
  /* ---------- ストック画像ラインナップ ---------- */
  bakezouri: {
    id: 'bakezouri', name: '化け草履', atk: 100, rarity: 'N', gachaOnly: true,
  ...
  sunekosuri: {
    id: 'sunekosuri', name: 'すねこすり', atk: 115, rarity: 'N', gachaOnly: true,
  ...
  kodama: {
    id: 'kodama', name: '木霊', atk: 105, rarity: 'N', gachaOnly: true,
  ...
  nopperabo: {
    id: 'nopperabo', name: 'のっぺらぼう', atk: 165, rarity: 'R', gachaOnly: true,
  ...
  tenome: {
    id: 'tenome', name: '手の目', atk: 195, rarity: 'R', gachaOnly: true,
  ...
  inugami: {
    id: 'inugami', name: '犬神', atk: 215, rarity: 'R', gachaOnly: true,
  ...
  aoandon: {
    id: 'aoandon', name: '青行燈', atk: 155, rarity: 'SR', gachaOnly: true,
  ...
  wanyudo: {
    id: 'wanyudo', name: '輪入道', atk: 275, rarity: 'SR', gachaOnly: true,
  ...
  oomyukade: {
    id: 'oomyukade', name: '大百足', atk: 205, rarity: 'SR', gachaOnly: true,
  ...
  sukuna: {
    id: 'sukuna', name: '宿儺', atk: 380, rarity: 'SSR', gachaOnly: true,
    img: img('sukuna'), imgSm: imgSm('sukuna'),
    moveText: '金の動き(成:全方向1マス)',
    skill: { kind: 'dual', name: '双面', desc: 'この駒で取ったあと、着地マスに隣接する別の敵(大将以外)を1体追撃できる(2体目のダメージは半分)', mult: 0.5 },
    moves: { steps: STEPS_GOLD },
    promoted: { steps: STEPS_ALL8 },
    awakenName: '両面宿儺',
  },
  ...
  /* ---------- 攻め改善ラインナップ(食い逃げ・残火) ---------- */
  makuragaeshi: {
    id: 'makuragaeshi', name: '枕返し', atk: 170, rarity: 'R', gachaOnly: true,
  ...
  rinka: {
    id: 'rinka', name: '燐火', atk: 140, rarity: 'R', gachaOnly: true,
  ...
  tsurube: {
    id: 'tsurube', name: '釣瓶落とし', atk: 210, rarity: 'R', gachaOnly: true,
  ...
  shiranui: {
    id: 'shiranui', name: '不知火', atk: 260, rarity: 'SR', gachaOnly: true,
  ...
  enenra: {
    id: 'enenra', name: '煙々羅', atk: 200, rarity: 'SR', gachaOnly: true,
  ...
  ingyo: {
    id: 'ingyo', name: '隱神刑部', atk: 360, rarity: 'SSR', gachaOnly: true,
