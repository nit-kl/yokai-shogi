...
const ROWS = 6;
const MAX_HP = 3000;
const ZONE_DEPTH = 2; // 敵陣の深さ(成りゾーン)

const STEPS_ALL8 = [[0,-1],[1,-1],[-1,-1],[1,0],[-1,0],[0,1],[1,1],[-1,1]];
const STEPS_GOLD = [[0,-1],[1,-1],[-1,-1],[1,0],[-1,0],[0,1]];
const STEPS_DIAG4 = [[1,-1],[-1,-1],[1,1],[-1,1]];
const STEPS_ORTHO4 = [[0,-1],[1,0],[-1,0],[0,1]];
...
const YOKAI = {
  ...
  kyubi: {
    ...
    img: 'assets/pieces/processed/kyubi.png',
    moveText: '全方向に1マス',
  ...
  shuten: {
    ...
    img: 'assets/pieces/processed/shuten.png',
    moveText: '全方向に1マス',
  ...
  kooni: {
    ...
    img: 'assets/pieces/processed/kooni.png',
  ...
  nekomata: {
    ...
    img: 'assets/pieces/processed/nekomata.png',
  ...
  ittan: {
    ...
    img: 'assets/pieces/processed/ittan.png',
  ...
  nue: {
    ...
    img: 'assets/pieces/processed/nue.png',
  ...
  kappa: {
    ...
    img: 'assets/pieces/processed/kappa.png',
  ...
  nurikabe: {
    ...
    img: 'assets/pieces/processed/nurikabe.png',
  ...
  tengu: {
    ...
    img: 'assets/pieces/processed/tengu.png',
  ...
  rokuro: {
    ...
    img: 'assets/pieces/processed/rokuro.png',
  ...
  aooni: {
    ...
    img: 'assets/pieces/processed/aooni.png',
  ...
  kasha: {
    ...
    img: 'assets/pieces/processed/kasha.png',
    moveText: '斜めに1マス(成:斜め+前後)',
  ...
  kamaitachi: {
    ...
    img: 'assets/pieces/processed/kamaitachi.png',
    moveText: '前にどこまでも(成:+横・後ろ1マス)',
  ...
  hitouban: {
    ...
    img: 'assets/pieces/processed/hitouban.png',
    moveText: '横にどこまでも+前1マス(成:+後ろ・斜め前)',
  ...
  suiko: {
    ...
    img: 'assets/pieces/processed/suiko.png',
    moveText: '縦横に1マス(成:全方向1マス)',
  ...
  oonyudo: {
    ...
    img: 'assets/pieces/processed/oonyudo.png',
    moveText: '前と横に1マス(成:縦横+斜め前)',
  ...
  daitengu: {
    ...
    img: 'assets/pieces/processed/daitengu.png',
    moveText: '斜めに1〜2マス飛行・駒を飛び越す(成:+前後1マス)',
  ...
  raiju: {
    ...
    img: 'assets/pieces/processed/raiju.png',
    moveText: '前へ変則跳び・駒を飛び越す(成:+斜め1マス)',
  ...
  ibaraki: {
    ...
    img: 'assets/pieces/processed/ibaraki.png',
  ...
  tamamo: {
    ...
    img: 'assets/pieces/processed/tamamo.png',
    moveText: '全方向に1マス',
  ...
  sunakake: {
    ...
    img: 'assets/pieces/processed/sunakake.png',
    moveText: '前と斜め前に1マス(成:金の動き)',
  ...
  tsuchigumo: {
    ...
    img: 'assets/pieces/processed/tsuchigumo.png',
  ...
  yukionna: {
    ...
    img: 'assets/pieces/processed/yukionna.png',
  ...
  zashiki: {
    ...
    img: 'assets/pieces/processed/zashiki.png',
    moveText: '縦横に1マス(成:全方向1マス)',
  ...
  tanuki: {
    ...
    img: 'assets/pieces/processed/tanuki.png',
  ...
  onibi: {
    ...
    img: 'assets/pieces/processed/onibi.png',
  ...
  nurarihyon: {
    ...
    img: 'assets/pieces/processed/nurarihyon.png',
    moveText: '全方向に1マス',
...
const GACHA_POOL = Object.values(YOKAI)
...
const PLAYER_BOSS = 'kyubi';
const ENEMY_BOSS = 'shuten';

/* プリロード対象画像 */
const ALL_IMAGES = Object.values(YOKAI).map(y => y.img);
