...
- **Steam**(計画): 本体無料・**広告なし**。**初回は DLC なし**。公開後の収益は **全駒解放DLC**(収集時短)と **異装等の見た目DLC**。オンラインは Web と同一マッチプールでクロスプレイ。doc 23 / 25
...
| 26 | [UI/UX改善提案（Shadowverse参考）](26-uiux-shadowverse-inspired.md) | 現行画面のギャップ・継承/挑戦の指針・P0–P2の改善策。実装は未着手 |
